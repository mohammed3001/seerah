...
export function CoursesSection() {
  ...
  const actions = useSectionActions<"courses", Item>("courses", "courses", {
    name: null,
    institution: null,
    is_current: false,
    description: null,
  ...
  return (
    <section>
      <SectionHeader
        ...
        description="أضف الدورات والشهادات الاحترافية"
      />
      <SectionList<Item>
        items={actions.items}
        ...
        itemLabel={(item, idx) => item.name ?? `دورة ${idx + 1}`}
          ...
          return (
            <div className="space-y-4">
              <div className="grid gap-4 @xl:grid-cols-2">
                ...
                />
                <FloatingInput
                  label={`الجهة المقدمة ${editorLang === "ar" ? "(عربي)" : "(English)"}`}
